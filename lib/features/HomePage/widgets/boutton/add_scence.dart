          ...
          child:Container(
            ...
            child: TextButton(
              ...
              child:   Row(
                ...
                children: [
                  Image.asset('icon/addition.ico',height: 30,width: 30,) ,
                  SizedBox(width: 8), 
...
void _showBottomSheet(BuildContext context) {
    String device_name = '';String paired_device = ''; String device_type = '';


 void updateInputValue(String input,String newValue) {
    input = newValue;}  // Mettre à jour la variable avec la nouvelle valeur 
      ...
      return Scaffold(
        body: ClipRRect(
          ...
          child: Container(
            ...
            color: Colors.white, // Ajout de la couleur de fond pour mieux visualiser
            child: Column(
              children: [
                  ...
                  children: [
                   ...
                   const  SizedBox(width: 50),
                    TextButton(
                      ...
                      child:const  Text(
                        'Add Device',
                        style: TextStyle(fontSize: 15, color: Color(0xFF6900FF)),
                      ),
                    ),
                  ],
                ),
