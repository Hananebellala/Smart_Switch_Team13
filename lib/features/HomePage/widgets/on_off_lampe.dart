...
class on_off_lampe extends StatefulWidget {
  ...
  const on_off_lampe({required this.id,required this.code,required this.isLampOn,required this.lampIcon ,required this.malak});

  @override
  State<on_off_lampe> createState() => _on_off_lampeState(isLampOn: isLampOn,lampIcon:lampIcon,malak:malak);
}
...
class _on_off_lampeState extends State<on_off_lampe> {
  ...
  _on_off_lampeState({required this.isLampOn,required this.lampIcon,required this.malak});
